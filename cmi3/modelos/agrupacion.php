...
class queryAgrupacion{
  ...
  public function listar(){
    ...
    CASE when completocriterio.num=completoecho.num2 THEN '1' else '0.0' END as asistencia,
  ...
  public function listar2(){
    ...
    $sql2 = "
    select   @s:=@s + 1 id, DATE_FORMAT(DATE_ADD(FROM_UNIXTIME(c.startdate, '%Y-%m-%d'), INTERVAL 1 HOUR),'%d/%m/%Y') AS fecha_activado,
